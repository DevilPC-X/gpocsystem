...
<div class="container text-center">
    <div class="page-header">
        <h1>Usuarios
            <a href="{{route('usuarios.create')}}" class="btn btn-success btn-sm">Agregar nuevo <i
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('usuarios.edit', $var->id)}}" class="btn btn-info btn-sm">Actualizar <i
                                    class="fa fa-edit"></i>
                            </a>
                        </td>
                        <td>
                            <button class="btn btn-danger btn-sm" id="{{$var->id}}" onclick="deleteUsers(this);">
                                Eliminar
